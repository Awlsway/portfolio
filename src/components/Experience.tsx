...
const experiences = [
  {
    ...
    subtitle: 'Global Certification • Project Management Institute (PMI)',
    description:
      'Mastered strategic project execution and operational efficiency in complex clinical environments and digital health implementations.',
    badge: 'Certified',
  },
  {
    title: 'MPA Public Administration',
    subtitle: 'Policy & Management Concentration',
    description:
      'Developed frameworks for public health policy, focusing on harm reduction strategies and community-based health interventions across Myanmar.',
  },
  {
    title: 'MBBS Medical Degree',
    subtitle: 'Yangon, Myanmar',
    description:
      'Foundation of medical expertise and clinical practice in primary and tertiary care settings, forming the basis for healthcare technical leadership.',
  },
];
